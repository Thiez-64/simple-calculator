...
theButton.addEventListener('click', function (event) {
  ...
  var firstValue = parseInt(document.getElementById('firstValue').value); //prompt("Please enter a number ?"));

  var operator = document.getElementById('operator').value; //prompt("Please enter a operator (+/*-) ?");

  var secondValue = parseInt(document.getElementById('secondValue').value); //prompt("Please enter a second number ?"));

  var result = document.getElementById('result'); //console.log(firstValue, secondValue, operator);
  ...
  switch (operator) {
    ...
    case "-":
      var soustraction = firstValue - secondValue;
    ...
    default:
      var other = "Invalid operator";
      result.innerHTML = other;
      break;
  }
});
var selectCharactere = document.querySelector('.charactere');
var imgCharactere = document.querySelector('.img-charactere');
selectCharactere.addEventListener('change', function (event) {
...
var buttonMenu = document.querySelector('#menu-burger-position');
var navMenu = document.querySelector('#nav-barre');
...
},{}]},{},["../../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","JS/script.js"], null)
